...
def fetch_hubspot_data(email: str, resource: str, params: dict) -> dict:
    # TODO: Replace with real HubSpot API call
    return {"email": email, "resource": resource, "data": "stubbed hubspot data"}
...
def handle_mcp_call(body: MCPRequest) -> MCPResponse:
    ...
    data = fetch_hubspot_data(body.email, body.resource, body.params)
